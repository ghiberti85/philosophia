      ...
      <div className="space-y-8">
        {schools.map((school, i) => (
          <Link
            ...
            className={`group grid animate-fade-up items-center gap-6 rounded-2xl border border-gold-500/20 bg-white/50 p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-plinth dark:bg-midnight-800/50 md:grid-cols-[280px,1fr] ${
          ...
          >
            ...
            <div>
              ...
              <h2 className="mt-1 font-display text-3xl">{t(school.name, locale)}</h2>

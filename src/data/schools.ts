...
export const schools: School[] = [
  {
    ...
    keyWorks: [
      { title: { en: 'Apology', pt: 'Apologia' }, author: { en: 'Plato', pt: 'Platão' }, year: 'c. 399 BC', note: { en: 'Socrates\' defense speech at trial', pt: 'O discurso de defesa de Sócrates no julgamento' } },
      { title: { en: 'Meno', pt: 'Mênon' }, author: { en: 'Plato', pt: 'Platão' }, year: 'c. 385 BC', note: { en: 'On virtue and recollection', pt: 'Sobre a virtude e a reminiscência' } },
      { title: { en: 'Symposium', pt: 'O Banquete' }, author: { en: 'Plato', pt: 'Platão' }, year: 'c. 385 BC', note: { en: 'Dialogues on the nature of love', pt: 'Diálogos sobre a natureza do amor' } },
      { title: { en: 'Memorabilia', pt: 'Memoráveis' }, author: { en: 'Xenophon', pt: 'Xenofonte' }, year: 'c. 371 BC', note: { en: 'Recollections of Socrates', pt: 'Recordações de Sócrates' } },
      { title: { en: 'Phaedo', pt: 'Fédon' }, author: { en: 'Plato', pt: 'Platão' }, year: 'c. 380 BC', note: { en: 'Socrates\' final hours and the soul', pt: 'As últimas horas de Sócrates e a alma' } },
    ],
  },
  {
    slug: 'platonism',
    ...
    scene: 'academy',
    keyWorks: [
      { title: { en: 'The Republic', pt: 'A República' }, author: { en: 'Plato', pt: 'Platão' }, year: 'c. 380 BC', note: { en: 'Justice, the ideal state and the philosopher-king', pt: 'A justiça, o Estado ideal e o rei-filósofo' } },
      { title: { en: 'Timaeus', pt: 'Timeu' }, author: { en: 'Plato', pt: 'Platão' }, year: 'c. 360 BC', note: { en: 'The origin and nature of the cosmos', pt: 'A origem e natureza do cosmos' } },
      { title: { en: 'Phaedrus', pt: 'Fedro' }, author: { en: 'Plato', pt: 'Platão' }, year: 'c. 370 BC', note: { en: 'Love, beauty and the soul\'s wings', pt: 'O amor, a beleza e as asas da alma' } },
      { title: { en: 'Enneads', pt: 'Enéadas' }, author: { en: 'Plotinus', pt: 'Plotino' }, year: 'c. 270 AD', note: { en: 'The foundational text of Neoplatonism', pt: 'O texto fundador do neoplatonismo' } },
      { title: { en: 'Theaetetus', pt: 'Teeteto' }, author: { en: 'Plato', pt: 'Platão' }, year: 'c. 369 BC', note: { en: 'What is knowledge?', pt: 'O que é o conhecimento?' } },
    ],
  },
  {
    ...
    scene: 'lyceum',
    keyWorks: [
      { title: { en: 'Nicomachean Ethics', pt: 'Ética a Nicômaco' }, author: { en: 'Aristotle', pt: 'Aristóteles' }, year: 'c. 350 BC', note: { en: 'The definitive account of virtue and happiness', pt: 'O tratado definitivo sobre virtude e felicidade' } },
      { title: { en: 'Politics', pt: 'Política' }, author: { en: 'Aristotle', pt: 'Aristóteles' }, year: 'c. 350 BC', note: { en: 'Man as a political animal; forms of government', pt: 'O homem como animal político; formas de governo' } },
      { title: { en: 'Metaphysics', pt: 'Metafísica' }, author: { en: 'Aristotle', pt: 'Aristóteles' }, year: 'c. 350 BC', note: { en: 'Being, substance, and the unmoved mover', pt: 'O ser, a substância e o motor imóvel' } },
      { title: { en: 'Poetics', pt: 'Poética' }, author: { en: 'Aristotle', pt: 'Aristóteles' }, year: 'c. 335 BC', note: { en: 'Tragedy, mimesis and catharsis', pt: 'A tragédia, a mimese e a catarse' } },
      { title: { en: 'The Incoherence of the Incoherence', pt: 'A Incoerência da Incoerência' }, author: { en: 'Averroes', pt: 'Averróis' }, year: '1180', note: { en: 'Defence of Aristotelian philosophy', pt: 'Defesa da filosofia aristotélica' } },
    ],
  },
  {
    slug: 'stoicism',
    ...
    scene: 'stoa',
    keyWorks: [
      { title: { en: 'Meditations', pt: 'Meditações' }, author: { en: 'Marcus Aurelius', pt: 'Marco Aurélio' }, year: 'c. 170 AD', note: { en: 'Private journal of a philosopher-emperor', pt: 'Diário pessoal de um imperador filósofo' } },
      { title: { en: 'Letters to Lucilius', pt: 'Cartas a Lucílio' }, author: { en: 'Seneca', pt: 'Sêneca' }, year: 'c. 65 AD', note: { en: '124 letters on virtue, time and the good life', pt: '124 cartas sobre virtude, o tempo e a vida boa' } },
      { title: { en: 'Discourses', pt: 'Discursos' }, author: { en: 'Epictetus', pt: 'Epicteto' }, year: 'c. 108 AD', note: { en: 'Teachings transcribed by Arrian', pt: 'Ensinamentos transcritos por Arriano' } },
      { title: { en: 'Enchiridion', pt: 'Enchirídrion' }, author: { en: 'Epictetus', pt: 'Epicteto' }, year: 'c. 108 AD', note: { en: 'Handbook of Stoic practice', pt: 'Manual de prática estoica' } },
      { title: { en: 'On the Shortness of Life', pt: 'Sobre a Brevidade da Vida' }, author: { en: 'Seneca', pt: 'Sêneca' }, year: 'c. 49 AD', note: { en: 'On using time well', pt: 'Sobre o bom uso do tempo' } },
    ],
  },
  {
    slug: 'rationalism',
    ...
    scene: 'observatory',
    keyWorks: [
      { title: { en: 'Meditations on First Philosophy', pt: 'Meditações sobre Filosofia Primeira' }, author: { en: 'Descartes', pt: 'Descartes' }, year: '1641', note: { en: 'The cogito and the foundations of modern philosophy', pt: 'O cogito e os fundamentos da filosofia moderna' } },
      { title: { en: 'Ethics', pt: 'Ética' }, author: { en: 'Spinoza', pt: 'Espinosa' }, year: '1677', note: { en: 'God, mind and human freedom proved geometrically', pt: 'Deus, mente e liberdade humana provados geometricamente' } },
      { title: { en: 'Discourse on the Method', pt: 'Discurso sobre o Método' }, author: { en: 'Descartes', pt: 'Descartes' }, year: '1637', note: { en: 'How to conduct reason and seek truth', pt: 'Como conduzir a razão e buscar a verdade' } },
      { title: { en: 'Monadology', pt: 'Monadologia' }, author: { en: 'Leibniz', pt: 'Leibniz' }, year: '1714', note: { en: 'The universe as infinite simple substances', pt: 'O universo como substâncias simples infinitas' } },
      { title: { en: 'Theologico-Political Treatise', pt: 'Tratado Teológico-Político' }, author: { en: 'Spinoza', pt: 'Espinosa' }, year: '1670', note: { en: 'Freedom of thought and the secular state', pt: 'Liberdade de pensamento e o Estado secular' } },
    ],
  },
  {
    ...
    scene: 'library',
    keyWorks: [
      { title: { en: 'Critique of Pure Reason', pt: 'Crítica da Razão Pura' }, author: { en: 'Kant', pt: 'Kant' }, year: '1781', note: { en: 'The limits and structure of human knowledge', pt: 'Os limites e a estrutura do conhecimento humano' } },
      { title: { en: 'Groundwork for the Metaphysics of Morals', pt: 'Fundamentação da Metafísica dos Costumes' }, author: { en: 'Kant', pt: 'Kant' }, year: '1785', note: { en: 'The categorical imperative and human dignity', pt: 'O imperativo categórico e a dignidade humana' } },
      { title: { en: 'Phenomenology of Spirit', pt: 'Fenomenologia do Espírito' }, author: { en: 'Hegel', pt: 'Hegel' }, year: '1807', note: { en: 'Consciousness unfolding toward absolute knowledge', pt: 'A consciência desdobrando-se rumo ao saber absoluto' } },
      { title: { en: 'Science of Logic', pt: 'Ciência da Lógica' }, author: { en: 'Hegel', pt: 'Hegel' }, year: '1812', note: { en: 'Being, essence and the dialectical method', pt: 'O ser, a essência e o método dialético' } },
      { title: { en: 'Critique of Practical Reason', pt: 'Crítica da Razão Prática' }, author: { en: 'Kant', pt: 'Kant' }, year: '1788', note: { en: 'Moral law and freedom of the will', pt: 'A lei moral e a liberdade da vontade' } },
    ],
  },
  {
    slug: 'existentialism',
    ...
    scene: 'cafe',
    keyWorks: [
      { title: { en: 'Being and Nothingness', pt: 'O Ser e o Nada' }, author: { en: 'Sartre', pt: 'Sartre' }, year: '1943', note: { en: 'Consciousness, freedom and bad faith', pt: 'A consciência, a liberdade e a má-fé' } },
      { title: { en: 'The Second Sex', pt: 'O Segundo Sexo' }, author: { en: 'Simone de Beauvoir', pt: 'Simone de Beauvoir' }, year: '1949', note: { en: 'The founding text of modern feminist philosophy', pt: 'O texto fundador da filosofia feminista moderna' } },
      { title: { en: 'Thus Spoke Zarathustra', pt: 'Assim Falou Zaratustra' }, author: { en: 'Nietzsche', pt: 'Nietzsche' }, year: '1883', note: { en: 'The death of God and the Übermensch', pt: 'A morte de Deus e o Übermensch' } },
      { title: { en: 'Either/Or', pt: 'Ou... Ou' }, author: { en: 'Kierkegaard', pt: 'Kierkegaard' }, year: '1843', note: { en: 'The aesthetic and ethical stages of existence', pt: 'Os estágios estético e ético da existência' } },
      { title: { en: 'Beyond Good and Evil', pt: 'Para Além do Bem e do Mal' }, author: { en: 'Nietzsche', pt: 'Nietzsche' }, year: '1886', note: { en: 'Critique of morality and the will to power', pt: 'Crítica da moral e a vontade de potência' } },
    ],
  },
];
